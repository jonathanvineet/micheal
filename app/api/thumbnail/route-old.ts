...
const MAX_MEMORY_CACHE_SIZE = 100; // Max 100 thumbnails in memory

// Performance: Prevent duplicate simultaneous thumbnail generation (deduplication)
...
const thumbnailQueue: Array<{ key: string; resolve: (value: any) => void; reject: (reason: any) => void }> = [];
